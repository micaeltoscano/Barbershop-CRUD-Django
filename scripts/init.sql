...
CREATE TABLE AGENDA (
    ...
    STATUS VARCHAR(20) NOT NULL DEFAULT 'ATIVO' CHECK (STATUS IN ('ATIVO','CANCELADO','CONCLUIDO')),
...
CREATE TABLE PAGAMENTO (
    ...
    FORMA_PAGAMENTO VARCHAR(30) NOT NULL CHECK (
        FORMA_PAGAMENTO IN ('DINHEIRO','CARTAO_DEBITO','CARTAO_CREDITO','PIX','TRANSFERENCIA', 'BERRIES')),
